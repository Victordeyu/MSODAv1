...
# scs=['webcam','dslr']
# tg='amazon'
# scs=['webcam_webcam.csv','dslr_dslr.csv']
# tg='webcam_amazon.csv'
...
def Train(eta=0.002,gamma_tk=0.2,gamma_tu=0.5,gamma_s=0.57,conf=0):
    Cs_end,Cu_start=10,21
    # eta=eta
    # gamma_tk=gamma_tk
    # gamma_tu=0.7
...
for i,max_acc in enumerate(max_ACCs):
    print("Eta:{}\t Max_Acc:{}".format(para[i],max_acc))